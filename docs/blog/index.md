...
layout: default
title: "Blog"
description: "dotdog writing on agent-first documentation, structured specs, MCP, ARD, and the agent internet."
---

← [dotdog](https://specdog.github.io/dotdog)

# Blog

Notes on agent-first documentation, structured specs, MCP, ARD, and the agent internet.
