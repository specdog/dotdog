...
One bug in a smart contract costs millions. Write a complete spec — entities, states, events, constraints. Generate Solidity stubs from the spec. Deploy with confidence. See [dotdefi](https://github.com/specdog/dotdefi).
