...
> **Feed the dog. Ship with specs.** — Structured, AI-queryable software specifications. Write specs in `.dog` files (markdown + YAML), compile to `.dag` graphs (JSON), query via MCP. Built for humans and AI agents.
